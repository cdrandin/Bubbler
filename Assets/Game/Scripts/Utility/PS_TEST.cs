...
public class PS_TEST : MonoBehaviour 
{
	...
	private static PS_TEST _instance;
	...
	private class Pooled_Object
	{
		...
		public Pooled_Object(GameObject obj)
		{
			...
			if(PS_TEST.instance.object_hierarchy)
			{
		...
		{
			get { return (PS_TEST.instance.object_hierarchy)? _pool_root : null; }
		}
	}
	#endregion
	...
	public static PS_TEST instance
	{
		get 
		{ 
			if(_instance == null)
			{
				_instance = new GameObject("Pooling System").AddComponent<PS_TEST>();
			}
